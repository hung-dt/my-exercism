...
remaining_minutes_in_oven:
    ...
    call expected_minutes_in_oven    ; rax now contains 40
    sub rax, rdi
    ret
...
elapsed_time_in_minutes:
    ...
    call preparation_time_in_minutes    ; rax now contains preparation_time_in_minutes
    add rax, rsi                        ; rax = rax + rsi (minutes in the oven)
    ret
